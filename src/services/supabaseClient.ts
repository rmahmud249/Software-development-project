...
const initialDatabase = {
  categories: [
    ...
    },
    {
      ...
      slug: 'grocery',
      name: 'Groceries',
      description: 'Fresh essentials, pantry staples, and everyday household supplies.',
  ...
  products: [
    ...
    {
      id: 'prod-007',
      slug: 'aerobook-pro-laptop',
      title: 'AeroBook Pro Laptop',
      description: 'A slim 14-inch laptop with a sharp display, fast SSD, and all-day battery life.',
      price: 1299.0,
      sale_price: 1099.0,
      stock: 24,
      rating: 4.9,
      ...
      is_new: true,
      is_best_seller: true,
      flash_sale_end: new Date(Date.now() + 1000 * 60 * 60 * 6).toISOString(),
      created_at: '2026-07-19T09:10:00.000Z',
    },
    {
      id: 'prod-008',
      slug: 'lensmaster-mirrorless-camera',
      title: 'LensMaster Mirrorless Camera',
      description: 'Capture crisp detail with a fast autofocus system and cinematic image quality.',
      price: 899.0,
      sale_price: 799.0,
      stock: 16,
      rating: 4.8,
      ...
      tags: ['camera', 'photography', 'creator'],
      is_featured: true,
      is_flash_sale: false,
      is_new: true,
      is_best_seller: false,
      flash_sale_end: null,
      created_at: '2026-07-20T11:35:00.000Z',
    },
    {
      id: 'prod-009',
      slug: 'nova-x-smartphone',
      title: 'Nova X Smartphone',
      description: 'Stay connected with a vivid display, stellar camera setup, and fast charging.',
      price: 799.0,
      sale_price: 699.0,
      stock: 31,
      rating: 4.7,
      ...
      is_best_seller: true,
      flash_sale_end: null,
      created_at: '2026-07-21T08:20:00.000Z',
    },
    {
      id: 'prod-010',
      slug: 'fresh-harvest-grocery-basket',
      title: 'Fresh Harvest Grocery Basket',
      description: 'A colorful mix of pantry staples and everyday essentials for your kitchen.',
      price: 54.99,
      sale_price: 44.99,
      stock: 44,
      rating: 4.6,
      ...
      is_new: true,
      is_best_seller: false,
      flash_sale_end: new Date(Date.now() + 1000 * 60 * 60 * 8).toISOString(),
    ...
    },
    {
      ...
      description: 'Immersive studio-grade sound for work, travel, and everyday listening.',
      price: 189.0,
      sale_price: 149.0,
      stock: 27,
      rating: 4.8,
      ...
      is_best_seller: false,
      flash_sale_end: null,
      created_at: '2026-07-23T10:45:00.000Z',
    },
  ],
  reviews: [
    {
